                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 px-5">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control gambar @error('gambar') is-invalid @enderror" name="gambar" id="gambar" value="{{ $informasi->gambar }}" data-default-file="{{ asset('/img/gambar/'.$informasi->gambar) }}" data-height="282">
                                    @error('gambar')
                            ...
                            <div class="col-md-5 px-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi" placeholder="Deskripsi" rows="5">{{ $informasi->deskripsi }}</textarea>
                                    @error('deskripsi')
                                          <div class="text-danger small mt-1">{{ $message }}</div>
                                      @enderror
                                  </div>
